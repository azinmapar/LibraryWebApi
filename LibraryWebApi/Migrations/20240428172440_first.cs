        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_RegisterManagerId",
                        column: x => x.RegisterManagerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_AspNetUsers_RegisterLibrarianId",
                        column: x => x.RegisterLibrarianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookEditions", x => x.EditionId);
                    table.ForeignKey(
                        name: "FK_BookEditions_AspNetUsers_RegisterLibrarianId",
                        column: x => x.RegisterLibrarianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lends_AspNetUsers_LibrarianId",
                        column: x => x.LibrarianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Lends_BookEditions_EditionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookEditions_RegisterLibrarianId",
                table: "BookEditions",
                column: "RegisterLibrarianId");

            migrationBuilder.CreateIndex(
                name: "IX_Lends_EditionId",
                table: "Lends",
                column: "EditionId");

            migrationBuilder.CreateIndex(
                name: "IX_Lends_LibrarianId",
                table: "Lends",
                column: "LibrarianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Members_RegisterLibrarianId",
                table: "Members",
                column: "RegisterLibrarianId");
        }
